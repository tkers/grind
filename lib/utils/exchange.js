...
// returns whether the diff is an affordable exchanges
// i.e. does NOT result in any negative inventory values
export const canAfford = (inventory, diff) =>
  !someNegative(add(inventory, diff))
